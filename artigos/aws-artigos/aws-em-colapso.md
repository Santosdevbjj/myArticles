...
BbO problema: Durante a corrida para restabelecer serviços, controles de acesso podem ser relaxados.
...
- Brasil: O Banco Central já exige planos de continuidade de negócios robustos. Espera-se regulamentação mais específica sobre dependência de cloud nos próximos 18-24 meses.
 ...
 BPor quê: Se o problema é centralização, a solução é descentralizar.
...
Vvb"Você sabe construir sistemas que sobrevivem quando a AWS cai?"
